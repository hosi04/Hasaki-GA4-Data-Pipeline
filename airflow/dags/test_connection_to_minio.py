...
def explore_bucket_structure(**context):
    try:
        ...
        directories = [] # Save list top-level
        if 'CommonPrefixes' in response:
            for prefix in response['CommonPrefixes']:
                dir_name = prefix['Prefix'].rstrip('/') #Remove / end
...
def explore_ga4_data(**context):
    try:
        ...
        ga4_prefix = 'ga4-data/hasakiwork/analytics_253437596/events/2025/7/' #Path contain data ga4
            ...
            if 'Contents' in page:
                for obj in page['Contents']:
                    ...
                    file_info = {
                        ...
                        'extension': obj['Key'].split('.')[-1] if '.' in obj['Key'] else 'no_ext' #File type
                    }
        ...
        print(f"\n FILE LIST:")
        for i, file_info in enumerate(all_files):  # Removed [:20]
        ...
        # No need for the "and X more files" message if all are printed
...
#     bucket_name = "hasaki-datalake"
#     obj_key = 'ga4-data/hasakiwork/analytics_253437596/events/2025/4/15/0.parquet'
#     local_path = "/opt/airflow/data/data_example.parquet"
...
#     task_id = 'download_one_file',
#     python_callable=download_one_file,
#     dag=dag
# )
